...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Main content – mobile top padding increased to ~6rem (96px) */}
      <div className="flex-1 flex flex-col px-6 md:px-12 lg:px-20 max-w-[1600px] mx-auto w-full relative z-10 pt-[6rem] md:pt-24 pb-24 md:pb-0 justify-end md:justify-center">
          ...
          <div className="hidden md:flex md:col-span-6 flex-col gap-4 md:pl-8 pb-4 relative z-30">
            <div className="hero-4 space-y-4">
              ...
              <div>
                ...
                <div className="text-sm text-dark font-normal font-tech">2+ Years in Digital</div>
              </div>
              <div>
